...
/**
 * <p>Extracts from the request the data about the user and checks email for uniqueness.</p>
 * <p>Forms a new object and sends the service a command to update current user in the database.</p>
 */
