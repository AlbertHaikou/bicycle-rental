...
public class MessageUtils {
    ...
    public static final String NOT_MONEY_TO_RENT_BIKE_ERROR_MESSAGE = "NOT_MONEY_TO_RENT_BIKE_ERROR_MESSAGE";
    ...
    public static final String DELETE_BIKE_ERROR_MESSAGE = "DELETE_BIKE_ERROR_MESSAGE";
