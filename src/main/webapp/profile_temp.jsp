...
<main>
    <div class="text-center"><h3><fmt:message key="MY_PROFILE"/></h3></div>
    <br/>
    <table border=2>
        <thead>
        <tr>
    ...
    <div class="center-block btn-group">
        ...
        <a href="main?command=showRentalHistory">
            <button type="button" class="btn btn-success center-block"><fmt:message key="FULL_RENTAL_HISTORY"/></button>
        </a>
    </div>
    <br/>
</main>
